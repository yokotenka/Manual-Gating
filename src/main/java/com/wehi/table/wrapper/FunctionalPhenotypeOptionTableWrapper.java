...
public class FunctionalPhenotypeOptionTableWrapper extends TableWrapper<ChildPhenotypeTableEntry> implements Observer {
    ...
    public void update(String str1, String str2) {
        ...
        positive = new ChildPhenotypeTableEntry(str1, str2, ChildPhenotypeTableEntry.MARKER_COMBINATION.TWO_POSITIVE);
        negative = new ChildPhenotypeTableEntry(str1, str2, ChildPhenotypeTableEntry.MARKER_COMBINATION.TWO_NEGATIVE);
        list.addAll(positive, negative);
        this.setItems(list);
    }

...
-there was a bug where if you keep clicking update phenotype, the phenotype name keeps getting concatenated eg. immune: immune: immune. This was fixed by adding in a condition on line 704 by calling checkForSingleClassification() which check if the path class already contains a certain name. 
